{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNvkK6xZ061Q9JIMEKLVGBC",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/pdu0323-source/effective-dollop/blob/main/soccer2.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        ...
        "\n",
        "    # 5. 로고 및 스폰서 영역 (선택 사항으로, 색상 C3를 사용)\n",
        "    ax.add_patch(Circle((0, 4), 1.5, facecolor=C3, edgecolor='black', linewidth=0.3, alpha=0.7)) # 로고 영역\n",
        "    ax.add_patch(Rectangle((-3, 1), 6, 1, facecolor=C3, edgecolor='none', alpha=0.7)) # 스폰서 영역\n",
        "\n",
        "# =========================================================\n",
        "# 3. Streamlit 앱 구성\n",
        "# =========================================================\n",
        ...
        "        \"패턴 유형을 선택하세요:\",\n",
        "        pattern_options,\n",
        "        index=random.randint(0, 3) # 앱 실행 시 랜덤 패턴이 선택되도록\n",
        "    )\n",
        "\n",
        "    # 랜덤 시드 입력 (재현성을 위해)\n",
        ...
        "\n",
        "        st.subheader(f\"✨ {selected_team} 유니폼 생성 결과 (패턴: {selected_pattern})\")\n",
        "\n",
        "        # 1. 색상 정보 표시\n",
        "        st.markdown(f\"**사용된 색상:** 메인(`{colors_data[0]}`), 보조(`{colors_data[1]}`), 배경/패턴(`{colors_data[2]}`)\")\n",
        "\n",
        "        # 2. 이미지 생성 및 표시\n",
        ...
        "                mime=\"image/png\"\n",
        "            )\n",
        "        st.info(\"Seed 값을 변경하거나 패턴 유형을 바꾸면 팀 색상을 유지하면서도 다양한 디자인을 탐색할 수 있습니다.\")\n",
        "\n",
        "\n",
